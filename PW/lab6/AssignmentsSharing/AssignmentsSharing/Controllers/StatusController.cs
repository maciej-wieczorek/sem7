...
namespace AssignmentsSharing.Controllers
{
    public class StatusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Type,OccuranceTime")] Status status)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Type,OccuranceTime")] Status status)
        {
            if (id != status.Id)
            {
                return NotFound();
