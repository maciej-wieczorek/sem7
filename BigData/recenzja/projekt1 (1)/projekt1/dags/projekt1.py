...
with DAG(
    ...
    params={
      "dags_home": Param("/home/NAZWA_KATALOGU/airflow/dags", type="string"),
      "input_dir": Param("gs://NAZWA_ZASOBNIKA/projekt1/input", type="string"),
...
-files {{ params.dags_home }}/project_files/mapper1.py,\
{{ params.dags_home }}/project_files/reducer1.py \
...
-output {{ params.output_mr_dir }}""",
  ...
  hive = BashOperator(
    ...
    bash_command="""beeline -u jdbc:hive2://localhost:10000/default \
      -f {{ params.dags_home }}/project_files/hive_script_p.hql \
